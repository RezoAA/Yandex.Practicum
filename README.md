...
### Проект 8: Защита персональных данных клиентов (personal_data_protection)
Описание проекта

*Нужно защитить данные клиентов страховой компании «Хоть потоп». Кроме того, необходимо разработать такой метод преобразования данных, чтобы по ним было сложно восстановить персональную информацию. Обоснуйте корректность его работы.*

**Получены следующие результаты работы:**

- создана случайная обратимая матрица.
- умножили признаки на нашу обратимую матрицу. Таким образом мы зашифровали наши признаки.
- обучили модель и посмотрели изменится ли r2, если обучить модель на зашифрованных признаках.
