...
**Получены следующие результаты работы:**
В проекте реализована идея, лежащая в основании машинного обучения - подготовлены модель, которая обучается методами классификации и анализирует поведение клиентов, предлагая пользователям новый тариф: "Умный" или "Ультра". 
